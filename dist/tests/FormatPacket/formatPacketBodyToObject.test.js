...
describe('formatPacketBodyToObject', () => {
    ...
    describe('formatEventToObject', () => {
        ...
        it('should format and return PacketResponse', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield (0, formatPacketBodyToObject_1.formatEventToObject)(eventPacket, header, collection);
            const event = {
                header: {
                    msgId: 2054,
                    operation: 'create',
    ...
    describe('formatMarketToObject', () => {
        ...
        it('should format and return PacketResponse', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield (0, formatPacketBodyToObject_1.formatMarketToObject)(marketPacket, header, collection);
            const market = {
                header: {
                    msgId: 61,
                    operation: 'create',
    ...
    describe('formatOperationToObject', () => {
        ...
        it('should format and return PacketResponse', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield (0, formatPacketBodyToObject_1.formatOutcomeToObject)(outcomePacket, header, collection);
            const outcome = {
                header: {
                    msgId: 62,
                    operation: 'create',
...
//# sourceMappingURL=formatPacketBodyToObject.test.js.map