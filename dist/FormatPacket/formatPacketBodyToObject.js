...
exports.formatOutcomeToObject = exports.formatMarketToObject = exports.formatEventToObject = void 0;
const storeFixtures_1 = require("../StoreFixtures/storeFixtures");
const formatEventToObject = (packetArray, header, collection) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.formatEventToObject = formatEventToObject;
const formatMarketToObject = (packetArray, header, collection) => __awaiter(void 0, void 0, void 0, function* () {
    const eventId = packetArray[4];
...
exports.formatMarketToObject = formatMarketToObject;
const formatOutcomeToObject = (packetArray, header, collection) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.formatOutcomeToObject = formatOutcomeToObject;
//# sourceMappingURL=formatPacketBodyToObject.js.map